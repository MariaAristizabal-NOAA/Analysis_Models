...
year = '2024'
hafs = ['hfsa','hfsa']
url_NDBC = '/scratch1/NCEPDEV/hwrf/noscrub/Maria.Aristizabal/Data/NDBC_buoys/2024/NDBC_buoy_around_Milton.nc'
...
#for st in np.unique(stationB):
#for st in np.unique(stationB)[0:4]:
#for st in ['42023']:
#for st in ['42098']:
#for st in ['42013']:
#for st in ['CWBF1']:
for st in ['VENF1']:
    okst = stationB == st
    print(np.unique(stationB[okst]))
    print(np.unique(latB[okst]))
    ...
    for i,folder in enumerate(folder_exps):
        ...
        target_timeBww3, target_wspdB[i,:] = get_var_from_ww3_grb2_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],grib2file,'ws',typeoflevel='surface',level=1)
    
        target_timeBww3, target_wdB[i,:] = get_var_from_ww3_grb2_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],grib2file,'wdir',typeoflevel='surface',level=1)
    
        target_timeBww3, target_wvhtB[i,:] = get_var_from_ww3_grb2_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],grib2file,'swh',typeoflevel='surface',level=1)
    
        target_timeBww3, target_dpdB[i,:] = get_var_from_ww3_grb2_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],grib2file,'perpw',typeoflevel='surface',level=1)
    
        target_timeBww3, target_apdB[i,:] = get_var_from_ww3_grb2_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],grib2file,'mwp',typeoflevel='surface',level=1)
    
        target_timeBww3, target_mwdB[i,:] = get_var_from_ww3_grb2_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],grib2file,'dirpw',typeoflevel='surface',level=1)
        ...
        target_timeBocean, target_wtmpB[i,0:len(ncfiles)] = get_var_from_model_following_trajectory(lon_obs[okst],lat_obs[okst],timestamp_obs[okst],ncfiles,temp_name,time_name=time_name,lon_name=lon_name,lat_name=lat_name,depth_level=0)
    ...
    plt.plot(lonB[okst],latB[okst],'*',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]),markersize=7)
    ...
    plt.plot(timesB[okst],wtmpB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
    ...
    fig,ax = plt.subplots(figsize=(10, 4))
    plt.plot(timesB[okst],wspdB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
    ...
    fig,ax = plt.subplots(figsize=(10, 4))
    plt.plot(timesB[okst],wvhtB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
    ...
    fig,ax = plt.subplots(figsize=(10, 4))
    plt.plot(timesB[okst],wdB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
    ...
    fig,ax = plt.subplots(figsize=(10, 4))
    plt.plot(timesB[okst],dpdB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
    ...
    fig,ax = plt.subplots(figsize=(10, 4))
    plt.plot(timesB[okst],apdB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
    ...
    fig,ax = plt.subplots(figsize=(10, 4))
    plt.plot(timesB[okst],mwdB[okst],'.-',color='blue',label='NDBC Buoy '+np.unique(stationB[okst]))
    for i in np.arange(len(exp_names)):
...
for i in np.arange(len(exp_names)):
    plt.plot(lon_forec_track[i,::2], lat_forec_track[i,::2],'o-',color=exp_colors[i],markeredgecolor='k',label=exp_labels[i],markersize=7)
plt.plot(lonB, latB,'*',color='blue',label='NDBC Buoy ',markersize=7)
