...
fig_appt4,appt4 = plt.subplots(figsize=(7,5))
plt.title('Mean (0-'+str(delta_r)+ ' km) Potential Perturbation Temperature ',fontsize=16)
plt.ylabel('Height ($Km$)',fontsize = 14)
plt.xlabel('Temperature ($K$)',fontsize=14)
plt.yticks(np.arange(0,21,2))
...
for h,hh in enumerate(fhours):
	...
	#################################################################################
        ...
        plt.savefig(dir_figures + 'PPT_'+exp_names[f]+'_'+cycle+'_'+ff.split('/')[-1]+'f'+hh,bbox_inches = 'tight',pad_inches = 0.1)
        ...
        if h == 3:
            appt4.plot(pot_pert_temp_dr[f,:,0],height[f,:],'X-',color=exp_colors[f],label=exp_names[f] + ' ' + cycle + ' ' + 'f' + str(hh),markeredgecolor='k',markersize=7)

    if h == 0:
        appt1.legend()
        fig_appt1.savefig(dir_figures + 'PPT_profile_'+cycle+'_f'+hh,bbox_inches = 'tight',pad_inches = 0.1)
        #apptt1.legend()
    ...
    if h == 1:
        appt2.legend()
        fig_appt2.savefig(dir_figures + 'PPT_profile_'+cycle+'_f'+hh,bbox_inches = 'tight',pad_inches = 0.1)
        #apptt2.legend()
    ...
    if h == 2:
        appt3.legend()
        fig_appt3.savefig(dir_figures + 'PPT_profile'+cycle+'_f'+hh,bbox_inches = 'tight',pad_inches = 0.1)

    if h == 3:
        appt4.legend()
        fig_appt4.savefig(dir_figures + 'PPT_profile'+cycle+'_f'+hh,bbox_inches = 'tight',pad_inches = 0.1)
#####################################################################################
