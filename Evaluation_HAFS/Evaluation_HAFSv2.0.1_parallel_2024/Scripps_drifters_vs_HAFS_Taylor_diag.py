...
for i,folder in enumerate(folder_exps):
    ...
    ############################################################################
    if exp_labels[i].split('_')[0] == 'epbl' or exp_labels[i].split('_')[0] == 'kpp' or exp_labels[i] == 'HFSAv1p1' or exp_labels[i] == 'HFSAv2a_baseline' or exp_labels[i] == 'HFSAv2a_baseline_latest' or exp_labels[i] == 'HKPP' or exp_labels[i] == 'HKP2':
