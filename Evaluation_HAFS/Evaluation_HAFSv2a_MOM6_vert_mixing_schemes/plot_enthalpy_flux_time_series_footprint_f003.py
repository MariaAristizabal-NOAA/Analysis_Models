...
for exp in np.arange(len(conf['COMhafs'])): 
    ...
    ax.fill_between(fhour.astype('int'),shfl_min[exp,:],shfl_max[exp,:],color=conf['exp_colors'][exp],alpha=0.1)
    plt.plot(fhour.astype('int'),shfl_max[exp,:],'.-',color=conf['exp_colors'][exp],markeredgecolor='k',markersize=7)
...
plt.savefig('shfl_time_series.png',bbox_inches='tight',dpi=150)
...
for exp in np.arange(len(conf['COMhafs'])):
    ...
    ax.fill_between(fhour.astype('int'),lhfl_min[exp,:],lhfl_max[exp,:],color=conf['exp_colors'][exp],alpha=0.1)
    plt.plot(fhour.astype('int'),lhfl_max[exp,:],'.-',color=conf['exp_colors'][exp],markeredgecolor='k',markersize=7)
...
plt.xlim([0,126])
plt.xticks(np.arange(0,126,12))
#plt.savefig('ltfl_time_series.png',bbox_inches='tight',dpi=150)
...
for exp in np.arange(len(conf['COMhafs'])):
    ...
    ax.fill_between(fhour.astype('int'),totfl_min[exp,:],totfl_max[exp,:],color=conf['exp_colors'][exp],alpha=0.1)
    plt.plot(fhour.astype('int'),totfl_max[exp,:],'.-',color=conf['exp_colors'][exp],markeredgecolor='k',markersize=7)
...
plt.xlim([0,126])
plt.xticks(np.arange(0,126,12))
#plt.savefig('total_flux_time_series.png',bbox_inches='tight',dpi=150)
