...
folder_exps = ['/work/noaa/hwrf/scrub/maristiz/hafs_20250210_HA30_Kd_output_MOM6_ePBL_CONSTANT_v2p1a_ha30/com/2023090706/13L/','/work/noaa/hwrf/scrub/maristiz/hafs_20250210_HA30_Kd_output_MOM6_ePBL_OM4_v2p1a_ha30/com/2023090706/13L/']
#exp_names = ['HFSAv2a_baseline_MOM6_epbl/OM4/','HFSAv2a_baseline_MOM6_epbl/OM4_LT/','HFSAv2a_baseline_MOM6_epbl/RH18/','HFSAv2a_baseline_MOM6_epbl/RH18_LT/']
exp_labels = ['CONSTANT','OM4']
exp_colors = ['deeppink','springgreen']
hafs_model = ['hfsa','hfsa']

'''
exp_names = ['HFSAv2a_baseline_MOM6_epbl/OM4/','HFSAv2a_baseline_MOM6_epbl/OM4_LT/','HFSAv2a_baseline_MOM6_epbl/RH18/','HFSAv2a_baseline_MOM6_epbl/RH18_LT/']
exp_labels = ['OM4','OM4_LT','RH18','RH18_LT']
exp_colors = ['lightcoral','deeppink','springgreen','forestgreen']
hafs_model = ['hfsa','hfsa','hfsa','hfsa']
'''

lon_lim = [-80,-55]
lat_lim = [10.0,40.0]

home_folder = '/home/maristiz/'
scratch_folder1 = '/work/noaa/hwrf/noscrub/maristiz/'
scrub_folder = '/work/noaa/hwrf/scrub/maristiz/'
abdeck_folder = '/work/noaa/hwrf/noscrub/input/abdeck/'
...
for i in np.arange(len(exp_names)):
    folder_exps.append(scrub_folder + exp_names[i] + '/' + cycle + '/' + storm_num + basin[-1] + '/')
'''
...
for ii,i in enumerate(np.arange(len(exp_labels))): 
