...
artofs_file = scratch_folder + 'RTOFS/rtofs.' + cycle + '/rtofs_glo.t00z.' + ff + '.archv.a'
...
ax.set_title('RTOFS SST ' + cycle +' '+ ff ,fontsize=18)
fname = cycle + '.rtofs.sst.' + ff + '.png'
...
cbar = fig.colorbar(ctr,pad=0.04,extendrect=True)
cbar.set_label(units,fontsize = 14)
plt.title(var_name + ' layer ' + klayer + ' ' + cycle + ' ' + ff,fontsize=18)
ax.set_title('RTOFS SST ' + cycle +' '+ ff ,fontsize=18)
