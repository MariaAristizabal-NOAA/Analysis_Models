...
storm_id = '18e'
storm_name = 'otis'
file_oisst = '/scratch1/NCEPDEV/hwrf/noscrub/Maria.Aristizabal/Data/OISST/' + cycle[0:4] + '/oisst-avhrr-v02r01.20231022.nc'
...
folder_exps = [scratch_folder + exp_names[0] + '/' + cycle + '/' + storm_num + basin[0] + '/']
...
plt.contour(lon_hafs_hycom-360,lat_hafs_hycom,SST_hafs_hycom,lev,colors='grey',alpha=0.5)
plt.contourf(lon_hafs_hycom-360,lat_hafs_hycom,SST_hafs_hycom,cmap='Spectral_r',**kw) 
...
plt.ylim(lat_lim)
plt.xlim(lon_lim)
plt.title('SST HAFS-HYCOM '+ str(time_hycom[n])[0:13]+' '+file.split('/')[-1].split('.')[-2])
plt.legend()
