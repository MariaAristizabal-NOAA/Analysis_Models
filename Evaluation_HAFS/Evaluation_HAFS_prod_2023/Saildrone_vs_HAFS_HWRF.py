...
#storm_num = '13'
#basin = 'al'
#url_saildrone = '/scratch1/NCEPDEV/hwrf/noscrub/Maria.Aristizabal/Data/Saildrones/2023/sd1036_hurricane_2023.nc'

exp_names = ['HFSA_oper','HFSAv1p1_MOM6_epbl']
exp_labels = ['HFSA','HFXA']
exp_colors = ['darkviolet','magenta']
#exp_names = ['HFSA_oper','HFSAv1p1_MOM6_epbl','HFSAv1p1_HYCOM']
...
for i,folder in enumerate(folder_exps):
    ...
    if exp_names[i] == 'HFSA_oper' or exp_names[i] == 'HFSB' or exp_names[i] == 'HFSAv1p1_HYCOM' or exp_names[i] == 'HWRF_HYCOM':
        #%% Get list files
