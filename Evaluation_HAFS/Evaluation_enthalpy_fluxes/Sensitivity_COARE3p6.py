...
plt.plot(timeS,CdS,'.-',color='blue',label='Cd')
plt.plot(timeS,ChS,'.-',color='lightcoral',label='Ch')
plt.plot(timeS,CeS,'.-',color='lightseagreen',label='Cl')
plt.legend(loc='lower right')
plt.title('Saildrone sd'+dataset_id,fontsize=18)
