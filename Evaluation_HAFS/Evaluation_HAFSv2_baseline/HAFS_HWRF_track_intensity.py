...
#exp_colors = ['orange','blue']

#exp_names = ['HFSAv1p1_MOM6_epbl','HFSAv2a_baseline','HFSAv2a_baseline_latest','HFSBv1p1_HYCOM','HFSAv2b_baseline','HFSAv2b_baseline_latest']
#exp_labels = ['HFSAv1p1','HFSAv2a_baseline','HFSAv2a_baseline_latest','HFSBv1p1','HFSAv2b_baseline','HFSAv2b_baseline_latest']
#exp_colors = ['darkviolet','mediumpurple','fuchsia','lawngreen','seagreen','mediumspringgreen']
...
for i,folder in enumerate(folder_exps):
    ...
    if exp_names[i] == 'HFSAv1p1_MOM6_epbl' or exp_names[i] == 'HFSAv2a_baseline' or exp_names[i] == 'HFSAv2a_baseline_latest' or exp_names[i] == 'HSSC' or exp_names[i] == 'HAFSv2_h3a0' or exp_names[i] == 'HAFSv2_h3a0_rtofsv2':
        file_track = folder + storm_id+'.' + cycle + '.hfsa.trak.atcfunix'
        print(file_track)
    if exp_names[i] == 'HFSBv1p1_HYCOM' or exp_names[i] == 'HFSB_oper' or exp_names[i] == 'HFSAv2b_baseline_latest' or exp_names[i] == 'HFSAv2b_baseline':
