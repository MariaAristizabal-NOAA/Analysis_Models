...
exp_names = ['HAFSv2_h3a0','HAFSv2_h3a0_rtofsv2']
exp_labels = ['HFSAv2a_RTOFS_prod','HFSAv2a_RTOFS_paral']
exp_colors = ['red','orange']

#exp_names = ['HFSB_oper','HFSBv1p1_HYCOM','HFSAv2b_baseline','HFSAv2b_baseline_latest']
#exp_labels = ['HFSB_FY2023','HFSBv1.1','HFSAv2b_baseline','HFSAv2b_baseline_latest']
#exp_colors = ['lawngreen','seagreen','aqua','royalblue']
...
for code in [1301700.]:
    ...
    for i,folder in enumerate(folder_exps):
        ...
        if exp_names[i] == 'HFSA_oper' or exp_names[i] == 'HFSB' or exp_names[i] == 'HFSAv1p1_HYCOM' or exp_names[i] == 'HFSBv1p1_HYCOM' or exp_names[i] == 'HFSB_oper' or exp_names[i] == 'HFSAv2b_baseline' or exp_names[i] == 'HFSAv2b_baseline_latest':
            #%% Get list files
        ...
        if exp_labels[i].split('_')[0] == 'epbl' or exp_labels[i].split('_')[0] == 'kpp' or exp_labels[i] == 'HFSAv1p1' or exp_labels[i] == 'HFSAv2a_baseline' or exp_labels[i] == 'HFSAv2a_baseline_latest' or exp_names[i] == "HAFSv2_h3a0_rtofsv2"  or exp_names[i] == "HAFSv2_h3a0":
            ...
            target_timedatm, target_press_surf[i,0:len(files_model)] = get_var_from_model_following_trajectory(files_model,'PRMSL_P0_L101_GLL0',time_name,lon_name,lat_name,lon_obs,lat_obs,timestamp_obs)
