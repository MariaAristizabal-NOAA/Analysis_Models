...
exp_names = ['HFSA_oper','HAFS_v2p2a_gfsv17','HFSB_oper','HAFS_v2p2b_gfsv17']
exp_labels = ['HFSA','HFSA_GFSv17','HFSB','HFSB_GFSv17']
exp_colors = ['darkviolet','deeppink','lime','lightseagreen']
