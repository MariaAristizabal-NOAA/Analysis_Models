...
exp_names = ['HFSA_oper','HFSB_oper','HV2A','HV2B']
exp_labels = ['HFSA','HFSB','HV2A','HV2B']
exp_colors = ['purple','green','lightskyblue','orange']
...
for i,folder in enumerate(folder_exps):
    ...
    if exp_labels[i] == 'HFSA' or exp_labels[i] == 'HV2A':
        file_track = folder + storm_id+'.' + cycle + '.hfsa.trak.atcfunix'
        file_track = folder + storm_id+'.' + cycle + '.hfsa.trak.atcfunix'
    if  exp_labels[i] == 'HFSB' or exp_labels[i] == 'HV2B':
...
for code in [1301700.]:
    ...
    for i,folder in enumerate(folder_exps):
        ...
        if exp_labels[i] == 'HFSA' or exp_labels[i] == 'HFSB' or exp_labels[i] == 'HV2B':
            #%% Get list files
