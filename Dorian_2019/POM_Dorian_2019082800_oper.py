...
folder = '/scratch2/NOS/nosofs/Maria.Aristizabal/dorian05l.2019082800_oper/'
...
# for glider ng665 cycle 2019082818_oper and 2019082800_oper
oklatpom_ng665 = np.array([112, 112, 112, 112, 112, 112, 112, 112, 112, 112, 112, 112, 112,112, 112, 112, 112, 112, 112, 112, 112])
...
np.savez('POM_Dorian_2019082800_oper.npz',time_pom_oper=time_pom,timestamp_pom_oper=timestamp_pom,target_temp_pom_oper=target_temp_pom,target_salt_pom_oper=target_salt_pom,z_matrix_pom_oper=z_matrix_pom,MLD_dt_pom_oper=MLD_dt_pom,MLD_drho_pom_oper=MLD_drho_pom,Tmean_dtemp_pom_oper=Tmean_dtemp_pom,Tmean_drho_pom_oper=Tmean_drho_pom,temp_prof_pom_oper=temp_prof_pom,depth_prof_pom_oper=depth_prof_pom,target_dens_pom_oper=target_dens_pom,Smean_dtemp_pom_oper=Smean_dtemp_pom,Smean_drho_pom_oper=Smean_drho_pom)

#np.savez('POM_Dorian_2019082800_exp.npz',time_pom_exp=time_pom,timestamp_pom_exp=timestamp_pom,target_temp_pom_exp=target_temp_pom,target_salt_pom_exp=target_salt_pom,z_matrix_pom_exp=z_matrix_pom,MLD_dt_pom_exp=MLD_dt_pom,MLD_drho_pom_exp=MLD_drho_pom,Tmean_dtemp_pom_exp=Tmean_dtemp_pom,Tmean_drho_pom_exp=Tmean_drho_pom,temp_prof_pom_exp=temp_prof_pom,depth_prof_pom_exp=depth_prof_pom)
