...
"""This script is to plot out HAFS atmospheric skin temperature, but only including the overlapping atmosphere over the ocean"""
...
# olotting only overlapping areas
tmp = tmp * data_interp
