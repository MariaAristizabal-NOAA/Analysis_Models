...
print('Extracting SHTFL at surface. The [1] field is the instantenous field. The [0] is the 6h average field')
shf = grb.select(shortName='SHTFL',level='surface')[1].data
...
ax.axis('scaled')
cf = ax.contourf(lon-180, lat, shf, cflevels, cmap='RdBu_r', extend='both', transform=transform)
