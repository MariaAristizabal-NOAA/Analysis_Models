...
url_drifter = '/scratch3/NCEPDEV/hwrf/noscrub/Maria.Aristizabal/Data/Scripts_lagrang_drifters/LDL_SST_Jan_2023_to_Jan_2026.nc'
...
folder_exps = ['/scratch4/HFIP/hafs-west/Maria.Aristizabal/ARAFS_Exp4_alaska_4_a_coupled/']
...
for wmo_num in [7801736.,2802110.,2802121.,3801723.]:
    ...
    plt.figure(figsize=(12,5))
    plt.plot(timedd,sstdd,'.-',label='Lagrangian Drifter: '+str(code_id))
    plt.title('Sea Surface Tenperature')
    plt.legend()
